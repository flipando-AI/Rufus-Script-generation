...
function updateOutput() {
  ...
  const output = `Craft a creative brief for an influencer campaign promoting ${input1} on ${input2}, targeting ${input3}, with the goal of ${input4}. 
Do it in Argentinean Spanish `;
